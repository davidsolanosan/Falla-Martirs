...
/**
 * Verifica si un usuario tiene permiso de login según su categoría
 */
export function hasLoginPermission(category: string): boolean {
  const allowedCategories = ['Adult', 'Jubilat'];
