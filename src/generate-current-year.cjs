...
async function generateCurrentYearLotteries() {
  console.log('Generando sorteos del año fallero 2026-2027...\n');
  ...
  try {
    ...
    console.log('Rango: Abril 2026 - Marzo 2027\n');
    ...
    console.log('\n--- SQL PARA INSERTAR ---');
    console.log('-- Borrar sorteos existentes');
    console.log('DELETE FROM lottery_dates WHERE date >= \'2026-04-01\' AND date <= \'2027-03-31\';');
    ...
    console.log('\n--- VERIFICACIÓN ---');
    console.log(`SELECT COUNT(*) as total_sorteos FROM lottery_dates WHERE date >= '2026-04-01' AND date <= '2027-03-31';`);
    console.log(`SELECT MIN(date) as primer_sorteo, MAX(date) as ultimo_sorteo FROM lottery_dates WHERE date >= '2026-04-01' AND date <= '2027-03-31';`);
