-- Migración simplificada para el sistema de autenticación de falleros
-- Ejecutar en Supabase SQL Editor

-- 1. Primero, verificar la estructura actual de la tabla
-- Descomenta esta línea para ver los campos actuales:
-- \d users

-- 2. Añadir campos de autenticación a la tabla users
ALTER TABLE users 
...
-- 4. Crear tabla de logs de autenticación
...
-- 5. Vista de usuarios con permiso de login (versión segura)
...
-- 6. Estadísticas de autenticación
...
-- 7. Función para resetear intentos de login
...
-- 8. Función para incrementar intentos fallidos
...
-- 9. Habilitar RLS para auth_logs
